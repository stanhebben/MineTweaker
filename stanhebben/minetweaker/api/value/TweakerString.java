...
public final class TweakerString extends TweakerValue {
	...
	public TweakerByte asByte() {
		try {
			return new TweakerByte(Byte.parseByte(value));
	...
	public TweakerShort asShort() {
		try {
			return new TweakerShort(Short.parseShort(value));
		} catch (NumberFormatException ex) {
			return null;
		}
	}
	...
	public TweakerInt asInt() {
		try {
			return new TweakerInt(Integer.parseInt(value));
		} catch (NumberFormatException ex) {
			return null;
		}
	}
	...
	public TweakerLong asLong() {
		try {
			return new TweakerLong(Long.parseLong(value));
		} catch (NumberFormatException ex) {
			return null;
		}
	}
	...
	public TweakerFloat asFloat() {
		try {
			return new TweakerFloat(Float.parseFloat(value));
		} catch (NumberFormatException ex) {
			return null;
		}
	}
	...
	public TweakerDouble asDouble() {
		try {
			return new TweakerDouble(Double.parseDouble(value));
		} catch (NumberFormatException ex) {
			return null;
		}
	}
	...
	public TweakerValue add(TweakerValue other) {
		if (other == null) {
			return new TweakerString(value + "null");
		}
		TweakerString ostring = other.asString();
		if (ostring == null) throw new TweakerExecuteException(other + " cannot be converted to string");
		return new TweakerString(value + ostring.value);
	}
	...
	public TweakerValue index(String index) {
		switch (TweakerField.get(index)) {
			case LENGTH:
				return new TweakerInt(value.length());
			case SUBSTRING:
			case SUBS:
				return new FunctionSubstring(value);
			case INDEXOF:
				return new FunctionIndexOf(value);
			case SPLIT:
				return new FunctionSplit(value);
		}
	 ...
	 */
	private final static String uniplus(String s) {
		if (s.length() == 0) {
			return "";
		}
