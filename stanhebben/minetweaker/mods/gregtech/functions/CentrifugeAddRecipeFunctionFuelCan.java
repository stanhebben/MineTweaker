...
public class CentrifugeAddRecipeFunctionFuelCan extends TweakerFunction {
	...
	public TweakerValue call(TweakerNameSpace namespace, TweakerValue... arguments) {
		if (arguments.length < 4) throw new TweakerExecuteException("centrifuge.addRecipeFuelCan requires 4 arguments");
		TweakerArray output =
		...
		Tweaker.apply(new CentrifugeAddRecipeAction(output1, output2, output3, output4, input, -1, duration));
		return null;
	}
