...
public class TweakerExpressionEq extends TweakerExpression {
	private TweakerExpression a;
	private TweakerExpression b;
	
	public TweakerExpressionEq(TweakerFile file, int line, int offset, TweakerExpression a, TweakerExpression b) {
