...
public class TweakerExpressionLt extends TweakerExpression {
	private TweakerExpression a;
	private TweakerExpression b;
	
	public TweakerExpressionLt(TweakerFile file, int line, int offset, TweakerExpression a, TweakerExpression b) {
